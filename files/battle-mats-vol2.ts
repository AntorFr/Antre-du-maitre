...
export interface BattleMat {
  id: string;
  volume: 1 | 2 | 3;
  pages: [number, number];     // double-page ex: [1, 2]
  nom: string;
  nomFr: string;
  description: string;         // description visuelle pour le LLM et l'app
  tags: BattleMatTag[];
  ambiances: string[];
  typesDefis: string[];        // ids gameplay recommandés pour cette carte
}
